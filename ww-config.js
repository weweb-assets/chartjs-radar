...
export default {
    editor: {
        label: "Chart - Radar",
        icon: "logos/chartjs",
        customStylePropertiesOrder: [["isLegend", "legendPosition", "legendAlignement", "legendSize", "legendColor"]],
    ...
    properties: {
        ...
        xAxisTitle: {
            ...
            responsive: true,
            states: true,
            hidden: (content) => !(content.dataType === "guided" && isDataValid(content.data) && isDataArrayObject(content.data)),
        },
        dataXField: {
            label: "Field",
        ...
        dataXFieldProperty: {
            ...
            hidden: (content) => {
                ...
                const field = _.get(data[0], content.dataXField);
                return !(content.dataType === "guided" && isDataValid(content.data) && isDataArrayObject(content.data) && Array.isArray(field) && field.length && typeof field[0] === "object");
            },
        },
        dataOrderBy: {
            label: "Order by",
        ...
        dataDirection: {
            ...
            section: "settings",
            defaultValue: "ASC",
            hidden: (content) => !(content.dataType === "guided" && content.dataOrderBy !== "default" && isDataValid(content.data)),
        },
        dataXEmpty: {
        ...
        dataYField: {
            ...
            section: "settings",
            defaultValue: null,
            hidden: (content) => !(content.dataType === "guided" && content.yAxis === "field-summary" && isDataValid(content.data) && isDataArrayObject(content.data)),
        },
        dataYFieldProperty: {
            label: "Field property",
            type: "ObjectPropertyPath",
            ...
            hidden: (content) => {
                ...
                if (!Array.isArray(data) || !data.length) return true;
                const field = _.get(data[0], content.dataYField);
                return !(content.dataType === "guided" && content.yAxis === "field-summary" && isDataValid(content.data) && isDataArrayObject(content.data) && Array.isArray(field) && field.length && typeof field[0] === "object");
            },
        },
        aggregate: {
            label: "Aggregate",
